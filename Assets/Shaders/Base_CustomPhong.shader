Shader "Custom/Base_CustomPhong" { //This is shows up in the editor
	Properties 
	{
	...
	SubShader {
		...
		inline fixed4 LightingPhong(SurfaceOutput s, half3 viewDir, UnityGI gi)
		{
			...
			float3 specular = pow(specularDot, _Shininess); //Inceases our specular
